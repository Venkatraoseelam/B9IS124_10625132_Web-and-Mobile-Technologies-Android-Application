...
public class Database extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "BikeService.db";
    ...
    public static final String BIKE_COL_1 = "reg_no";
    public static final String BIKE_COL_2 = "model";
    public static final String BIKE_COL_3 = "color";
    public static final String BIKE_COL_4 = "location";
    public static final String BIKE_COL_5 = "price";
    public static final String BIKE_COL_6 = "username";
    public static final String BIKE_COL_7 = "rating";
    public static final String BIKE_COL_8 = "bike_condition";
    ...
    public static final String TRANSACTION_COL_9 = "bike_rating";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_BIKE + "(reg_no int primary key," +
                ...
                "rating numeric(3,2) default 0," +
                "bike_condition varchar(50) not null," +
        ...
        db.execSQL("create table " + TABLE_TRANSACTION + "(transaction_id int primary key," +
                ...
                "bike_rating numeric(3,2) default 0," +
                "foreign key(username) references User(username) on delete cascade," +
                "foreign key(owner) references User(username) on delete cascade," +
                "foreign key(reg_no) references Bike(reg_no) on delete cascade);" );
    ...
    public boolean insertData_bike(int reg_no, String model, String color, String location, int price, String username, String condition) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(BIKE_COL_1, reg_no);
        contentValues.put(BIKE_COL_2, model);
        contentValues.put(BIKE_COL_3, color);
        contentValues.put(BIKE_COL_4, location);
        contentValues.put(BIKE_COL_5, price);
        contentValues.put(BIKE_COL_6, username);
        contentValues.put(BIKE_COL_7, 0);
        contentValues.put(BIKE_COL_8, condition);
        long result = db.insert(TABLE_BIKE,null, contentValues);
    ...
    public boolean updateData_Bike(String reg_no, String model, String color, String location, int price,String condition) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(BIKE_COL_1, Integer.parseInt(reg_no));
        contentValues.put(BIKE_COL_2, model);
        contentValues.put(BIKE_COL_3, color);
        contentValues.put(BIKE_COL_4, location);
        contentValues.put(BIKE_COL_5, price);
        contentValues.put(BIKE_COL_8, condition);
        db.update(TABLE_BIKE, contentValues, "reg_no=?", new String[]{reg_no});
        return true;
    }

    public void updateData_bike_rating(String reg_no) {
        SQLiteDatabase db = this.getWritableDatabase();

        db.execSQL("UPDATE "+TABLE_BIKE+" SET rating=(SELECT avg(bike_rating) FROM "+TABLE_TRANSACTION+" WHERE reg_no="+Integer.parseInt(reg_no)+") WHERE reg_no="+Integer.parseInt(reg_no)+";");
    }


    public boolean updateTransaction_rating_bike(String transac_id, float rating){
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public int deleteData_bike(String reg_no, String username){
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete(TABLE_BIKE, "reg_no=? AND username=?", new String[]{reg_no, username});
    }

    public int deleteData_bike_username(String username){
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete(TABLE_BIKE, "username=?", new String[]{username});
    }
    ...
    public Cursor getAllData_User_bike(){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT username, count(reg_no) as c from "+ TABLE_USER+" natural left outer join "+TABLE_BIKE+" group by username", null);
        return result;
    }
    ...
    public Cursor getRegNo_bike_username(String username){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT reg_no FROM "+TABLE_BIKE+" WHERE username=?", new String[]{username});
        return result;
    }
    ...
    public Cursor getAllData_bike(){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT * FROM "+TABLE_BIKE, null);
        return result;
    }

    public Cursor getData_bike_reg(String reg_no){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT * FROM "+TABLE_BIKE+" WHERE reg_no=?", new String[]{reg_no});
        return result;
    }

    public Cursor getData_bike_username(String username){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT * FROM "+TABLE_BIKE+" WHERE username=?", new String[]{username});
        return result;
    }

    public Cursor getData_bike_GetRide(String username, String date){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor result = db.rawQuery("SELECT * FROM "+TABLE_BIKE+" WHERE username!=? AND reg_no NOT IN (SELECT reg_no FROM "+TABLE_TRANSACTION+" WHERE end_date>=?)", new String[]{username, date});
        return result;
    }
