...
public class ViewBikeAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_bike_admin);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.nav_menu:
                Intent i = new Intent(ViewBikeAdmin.this, AdminMenu.class);
                startActivity(i);
                finish();
                break;

            case R.id.nav_profile:
                Intent i1 = new Intent(ViewBikeAdmin.this, AdminProfile.class);
                startActivity(i1);
                break;
    ...
    private void logout(){
        AlertDialog.Builder builder=new AlertDialog.Builder(ViewBikeAdmin.this);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(ViewBikeAdmin.this, MainActivity.class);
                startActivity(i);
    ...
    public void getData() {
        Cursor result = db.getAllData_bike();
    ...
    private void showMessage(String title, String message, final String reg_no, final String usrname) {
        ...
        builder.setNegativeButton("DELETE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                AlertDialog.Builder builder=new AlertDialog.Builder(ViewBikeAdmin.this); //Home is name of the activity
                builder.setMessage("Are you sure you want to delete bike?");
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if(res.getCount() > 0){
                            Toast.makeText(ViewBikeAdmin.this, "Cannot Delete. Bike is currently involved in a transaction.", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Integer deleteRows = db.deleteData_bike(reg_no,usrname);
                            if(deleteRows > 0) {
                                Toast.makeText(ViewBikeAdmin.this, "Bike Deleted", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(ViewBikeAdmin.this, "Bike Not Deleted", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
