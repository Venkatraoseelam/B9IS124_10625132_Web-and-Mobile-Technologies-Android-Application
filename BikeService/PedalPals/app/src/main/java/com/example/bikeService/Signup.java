...
public class Signup extends AppCompatActivity {
    ...
    EditText first_name, last_name, email, flat, address, username, password, re_password, mobile_number;
    TextView incorrect;
    Button signUp, login;
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(first_name.getText().toString().trim().equals("") || username.getText().toString().trim().equals("") ||
                                email.getText().toString().trim().equals("") || address.getText().toString().trim().equals("") || mobile_number.getText().toString().trim().equals("") ||
